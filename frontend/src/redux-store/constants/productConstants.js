export const PRODUCT_CONSTANT_TYPES = {
  ...
  PRODUCT_TOP_REVIEWED_REQUEST: "PRODUCT_TOP_REVIEWED_REQUEST",
  PRODUCT_TOP_REVIEWED_SUCCESS: "PRODUCT_TOP_REVIEWED_SUCCESS",
  PRODUCT_TOP_REVIEWED_FAIL: "PRODUCT_TOP_REVIEWED_FAIL",
};
